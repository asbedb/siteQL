...
export default function Home() {
        ...
        if (serviceBar.current) {
            ...
            if (mainArea) {
                mainArea.style.height = `${
                    window.innerHeight - serviceBar.current.offsetHeight
                }px`;
            }
        }
    };
    ...
    return (
        <Providers>
            <div className="flex flex-col w-screen h-screen text-foreground bg-background m-0 p-0">
